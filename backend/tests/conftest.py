...
from backend.src import my_app
from backend.src.auth.user_dependencies import get_user_info
from backend.src.shared.dependencies import get_auth_service,get_order_service
