...
from backend.src.auth.user_dependencies import get_user_info,RoleChecker,verify_email
from backend.src.shared.dependencies import get_cologne_service
from uuid import UUID
from backend.src.cologne.service import ColognesService
from backend.src.config.error_handling import CologneNotFound,DeleteCologne
