...
from backend.src.cologne.routes import cologne_router
from contextlib import asynccontextmanager
from backend.src.config.database import start_db
from backend.src.auth.routes import customer_routes
from backend.src.sales.routes import sales_router
from backend.src.config.error_handling import add_all_exceptions
from backend.src.config.middleware import adding_trusted_host_middleware,create_middleware,adding_CORS_middleware
@asynccontextmanager
